...
docker build \
        -t $CONTAINER_IMAGE_NAME:1.28.0 \
        -t $CONTAINER_IMAGE_NAME:1.28 \
        --build-arg serverlessVersion=1.28.0 .

docker build \
        -t $CONTAINER_IMAGE_NAME:1.27.3 \
        -t $CONTAINER_IMAGE_NAME:1.27 \
        --build-arg serverlessVersion=1.27.3 .
